        ...
        <table class="w-full border border-gray-300 dark:border-gray-700 rounded-lg">
            <thead class="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
                <tr>
                    ...
                    <th class="p-2 border border-gray-300 dark:border-gray-700">Modal per Unit</th>
                    <th class="p-2 border border-gray-300 dark:border-gray-700">Total Modal</th>
                </tr>
            </thead>
            ...
            <tbody class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100">
                ...
                @foreach ($this->getData() as $row)
                    @php
                        $modalUnit = $row->product?->capital_price ?? 0;
                        $rowTotal = $modalUnit * $row->qty;
            ...
            <tfoot class="bg-gray-200 dark:bg-gray-800 font-bold text-gray-800 dark:text-gray-100">
                <tr>
                    ...
                    <td class="p-2 border border-gray-300 dark:border-gray-700">Rp {{ number_format($totalModal) }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
